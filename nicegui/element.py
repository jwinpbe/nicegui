...
class Element(Visibility):
    ...
    def __init__(self: Self, tag: str | None = None, *, _client: Client | None = None) -> None:
        ...
        self._listener_id_counter: int = 0
    ...
    def on(self,
        ...
        *Updated in version 2.18.0: Both handlers can be specified at the same time.*
        ...
        if handler or js_handler:
            ...
            listener_number = self._listener_id_counter
            self._listener_id_counter = listener_number + 1
            listener_id = f'{element_id}:{listener_number}'
